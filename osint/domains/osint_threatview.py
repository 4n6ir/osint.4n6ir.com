...
class OsintThreatView(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        threatview = _lambda.Function(
            self,
            'threatview',
            runtime=_lambda.Runtime.PYTHON_3_13,
            architecture=_lambda.Architecture.ARM_64,
            code=_lambda.Code.from_asset('domains/threatview'),
        ...
        _logs.LogGroup(
            self,
            'logs',
            log_group_name='/aws/lambda/' + threatview.function_name,
        ...
        event.add_target(_targets.LambdaFunction(threatview))
