...
class OsintDisposableEmails(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        disposableemails = _lambda.Function(
            self,
            'disposableemails',
            runtime=_lambda.Runtime.PYTHON_3_13,
            architecture=_lambda.Architecture.ARM_64,
            code=_lambda.Code.from_asset('domains/disposableemails'),
        ...
        _logs.LogGroup(
            self,
            'logs',
            log_group_name='/aws/lambda/' + disposableemails.function_name,
        ...
        event.add_target(_targets.LambdaFunction(disposableemails))
