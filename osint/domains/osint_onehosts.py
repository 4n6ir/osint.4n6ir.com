...
class OsintOneHosts(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        onehosts = _lambda.Function(
            self,
            'onehosts',
            runtime=_lambda.Runtime.PYTHON_3_13,
            architecture=_lambda.Architecture.ARM_64,
            code=_lambda.Code.from_asset('domains/onehosts'),
            handler='onehosts.handler',
            environment=dict(
        ...
        _logs.LogGroup(
            self,
            'logs',
            log_group_name='/aws/lambda/' + onehosts.function_name,
        ...
        event.add_target(_targets.LambdaFunction(onehosts))
