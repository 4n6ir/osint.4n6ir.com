...
class OsintHagezi(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        hagezi = _lambda.Function(
            self,
            'hagezi',
            runtime=_lambda.Runtime.PYTHON_3_13,
            architecture=_lambda.Architecture.ARM_64,
            code=_lambda.Code.from_asset('domains/hagezi'),
            handler='hagezi.handler',
            environment=dict(
        ...
        _logs.LogGroup(
            self,
            'logs',
            log_group_name='/aws/lambda/' + hagezi.function_name,
        ...
        event.add_target(_targets.LambdaFunction(hagezi))
