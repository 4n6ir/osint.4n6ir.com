...
class OsintStevenBlack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        stevenblack = _lambda.Function(
            self,
            'stevenblack',
            runtime=_lambda.Runtime.PYTHON_3_13,
            architecture=_lambda.Architecture.ARM_64,
            code=_lambda.Code.from_asset('domains/stevenblack'),
            handler='stevenblack.handler',
            environment=dict(
        ...
        _logs.LogGroup(
            self,
            'logs',
            log_group_name='/aws/lambda/' + stevenblack.function_name,
        ...
        event.add_target(_targets.LambdaFunction(stevenblack))
